...
npm install ltzcore-payment-protocol --save
```
...
bower install ltzcore-payment-protocol --save
```
...
// send the transaction to the litecoinz network
```
