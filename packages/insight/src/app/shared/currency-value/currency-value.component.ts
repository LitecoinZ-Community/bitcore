...
export class CurrencyValueComponent implements OnChanges {
  ...
  amount: number;
  /**
   * The currency code/ticker symbol of the value. (E.g. when displaying a LTZ
   * value from the Ltzcore API, this should likely be `LTZ_satoshis`, even if
   ...
   * unit in which to display the value. (E.g. `LTZ_bits`, `LTZ`, `USD`, etc.)
   *
