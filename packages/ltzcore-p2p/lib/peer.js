 ...
 * using the standard LitecoinZ protocol. A Peer instance represents one connection
 * on the LitecoinZ network. To create a new peer connection provide the host and port
