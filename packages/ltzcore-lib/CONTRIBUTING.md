Contributing to Ltzcore
=======

We're working hard to make *ltzcore-lib* the most powerful JavaScript library for working with litecoinz. Our goal is to have *ltzcore-lib* be a library that can be used by anyone interested in litecoinz, and to level expertise differences with great design and documentation.
...
These are some global design goals in ltzcore-lib that any change must adhere.
...
When possible, ltzcore-lib objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of Ltzcore methods. For example, calling `JSON.stringify` on an Ltzcore object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'ltzcore-lib' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the ltzcore-lib object.
...
```sh
git remote add LitecoinZ-Community git@github.com:LitecoinZ-Community/ltzcore-lib.git
git pull --rebase LitecoinZ-Community master
```
...
```
Finally go to [github.com/LitecoinZ-Community/ltzcore-lib](https://github.com/LitecoinZ-Community/ltzcore-lib) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of ltzcore-lib.

If you have any questions feel free to post them to
[github.com/LitecoinZ-Community/ltzcore-lib/issues](https://github.com/LitecoinZ-Community/ltzcore-lib/issues).
